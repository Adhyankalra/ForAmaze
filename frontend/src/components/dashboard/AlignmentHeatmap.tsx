...
export function AlignmentHeatmap({ data }: AlignmentHeatmapProps) {
  ...
  const getCellColor = (value: number) => {
    if (value >= 0.7) return { bg: '#f97316', intensity: value };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="flex items-start gap-2">
            ...
            <p className="text-slate-400">
              <span className="text-orange-400 font-medium">Dark Orange cells</span> indicate strong entailment - the AI claim is directly supported by the source.
            </p>
          </div>
          <div className="flex items-start gap-2">
