  ...
  return (
    <header className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          >
            <div className="relative">
              ...
              <div className="relative p-3 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl">
          ...
          >
            ...
            <a 
              href="#" 
              className="flex items-center gap-2 px-4 py-2 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/30 rounded-lg text-sm text-orange-400 transition-colors"
            >
        ...
        >
          {[
            { label: 'Claims Analyzed', value: '6', color: 'text-orange-400' },
            { label: 'NLI Model', value: 'DeBERTa-v3', color: 'text-amber-400' },
            { label: 'Processing', value: '< 2s', color: 'text-red-400' },
            { label: 'Accuracy', value: '94.2%', color: 'text-rose-400' },
          ].map((stat) => (
            <div 
              key={stat.label}
